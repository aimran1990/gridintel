...
const S = {
  ...
  title: { fontSize: 13, fontWeight: 500, color: '#eeeeee', lineHeight: 1.4, marginBottom: 5 },
  summary: { fontSize: 11, color: '#999', lineHeight: 1.55, display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' },
